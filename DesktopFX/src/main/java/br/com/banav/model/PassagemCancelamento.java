...
@Entity
@Table(name = "passagem_cancelamento", schema = "offline")
public class PassagemCancelamento implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PassagemCancelamento checkIn = (PassagemCancelamento) o;
